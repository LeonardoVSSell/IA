...
def simular(linhas, colunas, num_formigas, num_comida, duracao_simulacao, intervalo_atualizacao, raio_visao, alfa, k1, k2):
    ...
    salvar_matriz_em_arquivo(matriz_comida, 'matriz_4_comida_0_quartos.txt')
    ...
    try:
        for i in range(duracao_simulacao):
            ...
            if i == duracao_simulacao//4:
                salvar_matriz_em_arquivo(matriz_comida, 'matriz_4_comida_1_quartos.txt')
            if i == duracao_simulacao//2:
                salvar_matriz_em_arquivo(matriz_comida, 'matriz_4_comida_2_quartos.txt')
            if i == (3*duracao_simulacao//4):
                salvar_matriz_em_arquivo(matriz_comida, 'matriz_4_comida_3_quartos.txt')
            #continue
    finally:
        parar_formigas(formigas)
        salvar_matriz_em_arquivo(matriz_comida, 'matriz_4_comida_4_quartos.txt')
